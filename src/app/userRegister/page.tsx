            ...
            <div className="d-flex justify-content-center align-items-center vh-100">
                <div className="container" style={{ maxWidth: "400px" }}>
                    <div className="text-center">
                        <h2 className="mb-4">User Sign-Up Form</h2>
                    </div>
                    ...
                    <div>
                        <form className="border p-4 rounded" onSubmit={addUserDetails}>
                            ...
                            <div className="mb-3">
                                ...
                                <input id="username" name="username" type="text" autoComplete="username" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="Enter username" required
                                    className="form-control" />
                            </div>
